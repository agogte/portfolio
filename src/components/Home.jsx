        ...
        <div className='max-w-screen-lg mx-auto flex flex-col  md:flex-row items-center px-4 justify-center h-full'>
            <div className='flex flex-col justify-center h-full'>
                ...
                <p className='py-4 text-gray-500'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut quia animi nesciunt laboriosam consequuntur impedit ratione deleniti ipsum incidunt. Ducimus?
                </p>
                <div>
